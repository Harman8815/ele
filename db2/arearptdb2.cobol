      ...
      *    OPEN CUSTOMER CURSOR TO FETCH ALL CUSTOMERS
           EXEC SQL
               OPEN CUST_CURSOR
           END-EXEC.
      ...
      *    ------------------------------------------------------------
      *    FETCH CUSTOMER ROW FROM DB2 CUSTOMER TABLE
      *    ------------------------------------------------------------
           EXEC SQL
               FETCH CUST_CURSOR
               INTO :HV-CUST-ID,
      ...
      *    ------------------------------------------------------------
       ...
       2500-FIND-READING  SECTION.
           ...
           PERFORM 2600-READ-TXN UNTIL TXN-EOF
                     OR TXN-METER-ID = HV-METER-ID.

           IF TXN-METER-ID = HV-METER-ID
       ...
       3100-PRINT-DETAIL  SECTION.
           ...
           IF TXN-METER-ID = HV-METER-ID
              MOVE HV-METER-ID TO WS-D-METERID
